class Quark {
	...
	a = Math.floor(10 * Math.random()) // strange quark decay
	...
	a = Math.floor(10 * Math.random()) // bottom quark decay
	...
	a = Math.floor(10 * Math.random()) // top quark decay
